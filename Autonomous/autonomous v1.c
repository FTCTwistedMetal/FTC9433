...
#pragma config(Sensor, S3,     irSeeker,       sensorPotentiometer) //Where's "HiTechnic1200 ir seeker"?
...
Chris: Imported code from chromebook onto the robotics laptop. Fixed some errors and setup "theoretical" (not wired yet...)
motors/servos/sensors. Created dropbox so I can move back and forth from robotics laptop to chromebook, and also be able to
work with the team even when I'm not there
*/
